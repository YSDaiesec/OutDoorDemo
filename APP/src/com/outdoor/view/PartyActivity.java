	...
	private Handler handler = new Handler(){
        ...
        public void handleMessage(Message msg) {
			...
			case Control.TO_CHAT_ACTIVITY:
				Intent toChatActivity = new Intent

(PartyActivity.this, ChatActivity.class);
				startActivity(toChatActivity);
				break;
			case Control.LOOK_IN_MAP:
				Intent tolookMapActivity = new Intent

(PartyActivity.this, LookInMapActivity.class);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//设置列表的点击事件
		partyJoinLv.setOnItemClickListener(this);
		partyFavoLv.setOnItemClickListener(this);
	...
	public void initData(){
		...
		partyJoinList.add(new Party("旅游", "武大看樱花", "武汉大学", 

"2014-3-2 14:00"));
		partyJoinList.add(new Party("骑车", "环东湖骑行", "东湖", "2014-3-20 9:00"));
		partyJoinList.add(new Party("登山", "去峨嵋山看日出", "峨嵋山", 

"2014-5-1 6:00"));
		partyJoinList.add(new Party("春游", "放风筝", "呼伦贝尔大草原", 

"2014-5-2 10:00"));
		
		partyFavoList = new ArrayList<Party>();
		partyFavoList.add(new Party("登山", "去峨嵋山看日出", "峨嵋山", 

"2014-5-1 6:00"));
		partyFavoList.add(new Party("春游", "放风筝", "呼伦贝尔大草原", 
...
();
		Intent toItemDetailActivity = new Intent(PartyActivity.this, 

ItemDetailActivity.class);
		startActivity(toItemDetailActivity);
		Log.i(TAG, "进入到活动详情页");
